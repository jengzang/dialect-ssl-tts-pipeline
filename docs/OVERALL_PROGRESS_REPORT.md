...
经过 19 小时的开发，我们已经完成了 LLM 训练学习路径的全部 7 个项目：
...
6. **Project 6**: 实现了高级微调技术（Prefix Tuning + Adapter）
7. **Project 7**: 实现了 RLHF 与人类反馈集成 ⭐ 新增
